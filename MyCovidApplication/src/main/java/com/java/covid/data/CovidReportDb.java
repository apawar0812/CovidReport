...
public class CovidReportDb {
	...
	@Column(name = "CONFIRNMENT")
	private Integer confirmed;
	@Column(name = "DEATHS")
	private Integer deaths;
	@Column(name = "RECOVRED")
	private Integer recovered;
	@Column(name = "ACTIVE")
	private Integer active;

	public CovidReportDb(CSVRecord record) {
		try {
	...
	public void aggregateCases(CovidReportDb covidReport) {
	...
	public void aggregate(CovidReportDb covidReport) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CovidReportDb other = (CovidReportDb) obj;
